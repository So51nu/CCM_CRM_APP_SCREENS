          ...
          children: [
            ...
            GlassCard(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const Text('Web CRM Telecaller Workspace me call button click karte hi app 1-2 seconds me native service ko trigger karega. Native service hi pending request pick karega, SIM call start karega, call end par recording upload karega. Same CRM user se app login hona chahiye.', style: TextStyle(color: CcColors.textMuted, height: 1.4)),
              ]),
            ),
            const SizedBox(height: 12),
            GlassCard(child: Column(children: [
              SwitchListTile(
                ...
                subtitle: const Text('Pending request milte hi mobile SIM se call start kare', style: TextStyle(color: CcColors.textMuted)),
              ...
              SwitchListTile(
                ...
                subtitle: const Text('Call end hone par recording CRM lead details me upload kare', style: TextStyle(color: CcColors.textMuted)),
                contentPadding: EdgeInsets.zero,
              ),
            ])),
            const SizedBox(height: 12),
            ...
            GlassCard(
              ...
              child: const Text(
                'Recording note: Android normal apps ko har device par direct system call audio access nahi milta. App microphone recording fallback use karta hai. Better result ke liye speaker mode, microphone permission aur battery unrestricted rakho.',
